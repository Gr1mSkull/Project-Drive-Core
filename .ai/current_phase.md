...
**Updated:** WP-014 Proposed — fixture and load-bank requirements (2026-07-20)
...
| **WP-014 fixture and load-bank requirements** | ⏳ Proposed — Architecture Review pending |
...
| Fixture requirements | **Proposed** (WP-014) |
| Fixture architecture | **Proposed** (WP-014) |
...
## Next authorized work (after WP-014 acceptance)

Fixture preliminary design requirements · ADR-DK-011/012 · abstract fixture component qualification (as authorized).

## Active branch

`cursor/wp014-devkit-fixture-load-bank-requirements-3bb9` — WP-014 Proposed
