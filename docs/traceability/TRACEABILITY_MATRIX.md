...
* WP-011 (2026-07-20): EDL-011 clarification **Ready for Final Architecture Review**; component-class framework **Ready for Final Architecture Review**; EDL files unchanged; TBD-DK-007 semantics Accepted (Option D); numeric Open; NOT VERIFIED unchanged.
* WP-011-R1 (2026-07-20): Option D scope statement; TBD-DK-007 disposition separation; evaluation-class terminology; ED-IN R6; qualification gating; no EDL/ADR/numeric changes.
