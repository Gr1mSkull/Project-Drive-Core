...
| FX-PD-004 | Ground/reference option | GND-OPTION-A/B/C/D1/D2 | Defer to dedicated package | BLOCKED_BY_ARCHITECTURE | Architect | OI-GND-001 | Blocks external/measurement design | OI-GND-001 decision |
