...
| Existing pass thresholds (±5%, 200 ms, 10.5 V, …) | docs/008 | TBD | Candidates | Vague terms (“immediately”, “waveform clean”) | **WP-009** timing/current budgets | Architect threshold review | P0 |
