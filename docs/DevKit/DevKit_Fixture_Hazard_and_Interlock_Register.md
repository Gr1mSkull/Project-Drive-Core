...
| H-FX-003 | Back-feed into base | Ext/base conflict | EXT→BASE | Base overstress | Back-feed prohibit; no silent merge | Disconnect | Ext/base current | Sources isolated | ENERGY_REMOVAL | OI-GND-001 | Architect |
| H-FX-004 | Source-to-source conflict | Dual source connect | BASE+EXT | Combined envelope | Prohibit unless Accepted topology | E-stop | Dual AUTH detect | Inhibit both | SAFE_OFF | Future ADR | Architect |
| H-FX-005 | Load-bank failure | LB stuck on | DUT out | Overload/heat | Fail-to-remove → ENERGY_REMOVAL | Channel/fixture | LB state/I | Remove AUTH_LB | LOCKOUT | — | Fixture design |
...
| H-FX-008 | Operator E-stop failure | E-stop path fault | Any fixture-controlled | Continued hazard | Dual-path design TBD | Independent removal | E-stop sense | Treat as failed-safe design req | Repair | Design | Fixture design |
