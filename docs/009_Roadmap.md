...
| WP-014 fixture and load-bank requirements | **Proposed** — Architecture Review pending; REQ-DCC-V-FX-*; fixture hardware NOT IMPLEMENTED |
...
**Next step:** Architecture Review of WP-014. After acceptance: fixture preliminary design requirements only (Architect-authorized).

**Next expected engineering stage:** Fixture prelim design (if authorized) · ADR-DK-011/012 · MPN qualification prep (after role inputs + Architect authorization) → (only then) schematic/PCB/firmware WPs. **Not authorized:** fixture construction / energization.
