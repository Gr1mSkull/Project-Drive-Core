...
| DK | [DevKit requirements](docs/DevKit/README.md) | Gen1 DevKit requirements (WP-007); P0 ADRs (WP-008); threshold analysis Accepted (WP-009); functional electrical architecture Accepted (WP-010) |
