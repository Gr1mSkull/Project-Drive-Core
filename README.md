...
| DK | [DevKit requirements](docs/DevKit/README.md) | Gen1 DevKit requirements (WP-007); P0 ADRs (WP-008); threshold analysis (WP-009); functional architecture (WP-010); EDL/component prep Accepted (WP-011); sizing framework Proposed (WP-012) |
